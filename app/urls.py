...
urlpatterns = [
    ...
    path('cars/', CarsListView.as_view(), name='cars_list'), #name: dá um nome para a url
    path('new_car', NewCarCreateView.as_view(), name='new_car'),
    path('cars/<int:pk>/', CarDetailView.as_view(), name='car_detail'), #pk: primary key, é o id do carro
